...
class CustomerController extends Controller
{
    ...
    {
        $post = Post::with('categories','user.profile','comments','ratings')->findOrFail($id);
        ...
        $rat = $post->ratings()->paginate(5);
        $template = 'customer.index';
        return view('customer.home', compact('categories','post','formattedDate', 'cmt','template','rat'));
    }
    ...
    public function index()
    {
        ...
        return view('customer.home', compact('posts', 'mainPost', 'additionalPosts', 'categories', 'template'));
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('customer.home', compact('posts', 'mainPost', 'additionalPosts', 'template','categories'));
    }
