...
Route::group(['middleware' => ['authenticate']], function () {  
    ...
    //     Route::get('/categories', [  Controller::class, 'index'])->name('cat.index');
    //     Route::get('/search', [  Controller::class, 'search'])->name('cat.search');
        Route::get('/create', [ Controller::class,'create'])->name('cat.create');
        Route::post('/store', [ Controller::class,'store'])->name('cat.store');
    //     Route::get('/{id}/edit', [   Controller::class, 'edit'])->where(['id' => '[0-9]+'])->name('cat.edit');
    //     Route::post('{id}/update', [ Controller::class, 'update'])->name('cat.update');
    //     Route::get('{id}/delete', [  Controller::class, 'delete'])->where(['id' => '[0-9]+'])->name('cat.delete');
    //     Route::delete('{id}/destroy', [  Controller::class, 'destroy'])->where(['id' => '[0-9]+'])->name('cat.destroy');
    });
