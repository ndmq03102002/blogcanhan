...
})->middleware('auththenticate');

Route::get('/dashboard', [DashboardController::class, 'index'])->name('auth.dashboard')->middleware('auththenticate');

Route::get('/home', [HomeController::class, 'index'])->name('blog.home')->middleware('auththenticate');
