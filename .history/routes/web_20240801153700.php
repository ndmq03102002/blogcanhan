...
Route::get('/', [LoginController::class, 'viewlogin'])->name('auth.login');
...
Route::group(['middleware' => ['authenticate']], function () {  
    ...
    Route::get('{id}/viewprofile', [ProfileController::class, 'edit'])->name('profile.view');
    
    Route::get('{id}/profile', [ProfileController::class, 'update'])->name('profile.update');
});
