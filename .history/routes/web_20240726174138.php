...
Route::group(['middleware' => ['authenticate']], function () {  
    ...
    Route::group(['prefix'=> 'category'], function () {
        ...
        Route::get('{id}/delete', [CategoryController::class, 'delete'])->where(['id' => '[0-9]+'])->name('user.delete');
        Route::delete('{id}/destroy', [CategoryController::class, 'destroy'])->where(['id' => '[0-9]+'])->name('user.destroy');
    });
