            ...
            <div class="col-lg-5">
                <div class="panel-head">
                    ...
                    <div class="panel-description">
                        <p>Bạn đang muốn xóa danh mục có tên là: {{ $cat->name }}</p>
                        <p>Lưu ý: Không thể khôi phục danh mục sau khi xóa và tất cả những danh mục con liên quan đến danh mục này sẽ đều bị xóa. Hãy chắc chắn bạn muốn thực hiện chức năng này</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-7">
