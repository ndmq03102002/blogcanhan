            ...
            <div class="col-lg-5">
                <div class="panel-head">
                    ...
                    <div class="panel-description">
                        <p>Bạn đang muốn xóa thành viên có email là: {{ $cat->name }}</p>
                ...
                <div class="ibox">
                    <div class="ibox-content">
                        <div class="row mb15">
                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    <label for="" class="control-label text-left">Desc<span class="text-danger">(*)</span></label>
                                    <input 
                                        type="text"
                                        name="username"
