...
<script type="module">
    ...
    ClassicEditor
        .create( document.querySelector( '#editor' ), {
            plugins: [ Essentials, Bold, Italic, Font, Paragraph, Image, ImageInsert, ImageUpload , AutoImage , ImageToolbar, ImageCaption, ImageStyle, ImageResize, LinkImage, PictureEditing, CKBox, CKBoxImageEdit, CloudServices],
            toolbar: {
                items: [
                    'undo', 'redo', '|', 'bold', 'italic', '|',
                    'fontSize', 'fontFamily', 'fontColor', 'fontBackgroundColor', 'insertImage', 'ckbox', 'ckboxImageEdit', 'linkImage', 'imageStyle:full', 'imageStyle:side', 'imageStyle:alignLeft', 'imageStyle:alignCenter', 'imageStyle:alignRight', 'imageResize', 'imageCaption', 'imageInsert', 'cloudServices'
                ]
