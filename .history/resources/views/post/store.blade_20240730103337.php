...
<script type="module">
    ...
    ClassicEditor
        .create( document.querySelector( '#editor' ), {
            plugins: [ Essentials, Bold, Italic, Font, Paragraph, Image, ImageInsert, ImageUpload , AutoImage , ImageToolbar, ImageCaption, ImageStyle, ImageResize, LinkImage, PictureEditing],
            toolbar: {
                items: [
