...
<script type="module">
    ...
    ClassicEditor
        .create(document.querySelector('#editor'), {
            plugins: [
                Essentials, Bold, Clipboard, Italic, Font, Paragraph, Image, ImageInsert, AutoImage, ImageToolbar, ImageCaption, ImageStyle, ImageResize, LinkImage, Alignment
            ],
            toolbar: {
                items: [
                    'undo', 'redo', '|', 'bold', 'italic', '|',
                    'fontSize', 'fontFamily', 'fontColor', 'fontBackgroundColor', 'insertImage', 'alignment', 'imageStyle:inline', 'imageStyle:full', 'imageStyle:side', 'imageResize'
                ],
            },
            image: {
                toolbar: [
                    ...
                    '|',
                    'imageStyle:inline', // Thêm nút inline
                    'imageStyle:full', // Thêm nút full
                    'imageStyle:side', // Thêm nút side
