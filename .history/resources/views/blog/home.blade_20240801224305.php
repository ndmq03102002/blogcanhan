                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="single-blog-post1 style-2 mb-5">
                                            ...
                                            <div class="blog-content">
                                                ...
                                                <a href="{{$url}}" class="post-author mb-30">By {{ $mainPost->user->name }}</a>
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="single-blog-post2 style-2 mb-5">
                                            <div class="blog-thumbnail">
                                                <a href="{{$url}}"><img src="{{ asset('storage/images/' . basename($post->image)) }}" alt="Post Image" class="img-fluid"></a>
                                            </div>
                                            <div class="blog-content">
