...
<body>
                                    ...
                                    <div class="col-12">
                                        <div class="single-blog-post style-2 mb-5">
                                            ...
                                            <div class="blog-thumbnail">
                                                <a href="#"><img src="fontend/img/bg-img/24.jpg" alt=""></a>
                                            </div>
    ...
    <div class="big-add-area">
        <div class="container-fluid">
            <a href="#"><img src="fontend/img/bg-img/add4.png" alt=""></a>
        </div>
    </div>
    <!-- ##### Add Area End ##### -->
            ...
            <div class="row">
                <div class="col-12 col-md-8 col-lg-9">
                    ...
                    <div class="single-blog-post d-flex flex-wrap style-5 mb-30">
                        <!-- Blog Thumbnail -->
                        <div class="blog-thumbnail">
                            <a href="#"><img src="fontend/img/bg-img/28.jpg" alt=""></a>
                        </div>
                    ...
                    <div class="single-blog-post d-flex flex-wrap style-5 mb-30">
                        <!-- Blog Thumbnail -->
                        <div class="blog-thumbnail">
                            <a href="#"><img src="fontend/img/bg-img/29.jpg" alt=""></a>
                        </div>
                    ...
                    <div class="single-blog-post d-flex flex-wrap style-5 mb-30">
                        <!-- Blog Thumbnail -->
                        <div class="blog-thumbnail">
                            <a href="#"><img src="fontend/img/bg-img/30.jpg" alt=""></a>
                        </div>
                ...
                <div class="col-12 col-md-4 col-lg-3">
                    ...
                    <div class="single-blog-post style-6 mb-30">
                        <!-- Blog Thumbnail -->
                        <div class="blog-thumbnail">
                            <a href="#"><img src="fontend/img/bg-img/11.jpg" alt=""></a>
                    ...
                    <div class="single-blog-post style-6 mb-30">
                        <!-- Blog Thumbnail -->
                        <div class="blog-thumbnail">
                            <a href="#"><img src="fontend/img/bg-img/12.jpg" alt=""></a>
                            <a href="#" class="video-btn"><i class="fa fa-play" aria-hidden="true"></i></a>
                        </div>
                    ...
                    <div class="single-blog-post style-6 mb-30">
                        <!-- Blog Thumbnail -->
                        <div class="blog-thumbnail">
                            <a href="#"><img src="fontend/img/bg-img/13.jpg" alt=""></a>
                            <a href="#" class="video-btn"><i class="fa fa-play" aria-hidden="true"></i></a>
                        </div>
