...
<div class="container">
    ...
    <div class="post-comments" id="comments-section">
        ...
        <div id="pagination-links">
            {{ $cmt->links('pagination::bootstrap-4')->render() }}
        </div>
    </div>
            ...
            if (event.target.tagName === 'A') {
                ...
                xhr.onload = function() {
                    if (xhr.status === 200) {
                        ...
                        // Cập nhật danh sách bình luận và liên kết phân trang
                        ...
                        document.getElementById('comments-list').innerHTML = newCommentsList;
