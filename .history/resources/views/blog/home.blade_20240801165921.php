                                    ...
                                    <div class="col-12">
                                        <div class="single-blog-post style-2 mb-5">
                                            ...
                                            <div class="blog-thumbnail">
                                                <a href="#"><img src="{{ asset('storage/' . $mainPost->image) }}" alt=""></a>
                                            </div>
                                            <!-- Blog Content -->
                                            <div class="blog-content">
                                                <span class="post-date">{{ $mainPost->updated_at->format('F d, Y') }}</span>
                                    ...
                                    @foreach($relatedPosts as $post)
                                        <div class="col-12 col-sm-6">
                                            <div class="single-blog-post style-2 mb-5">
                                                ...
                                                <!-- Blog Content -->
                                                <div class="blog-content">
                                                    <span class="post-date">{{ $post->updated_at->format('F d, Y') }}</span>
