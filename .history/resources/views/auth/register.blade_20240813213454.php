...
<body class="gray-bg">
    ...
    <!-- Mainly scripts -->
    <script src="templatejs/jquery-3.1.1.min.js"></script>
    <script src="templatejs/bootstrap.min.js"></script>
    <script src="templatejs/plugins/iCheck/icheck.min.js"></script>
    <script>
